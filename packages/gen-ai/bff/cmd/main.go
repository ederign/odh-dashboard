...
func main() {
	...
	flag.BoolVar(&cfg.MockMLFlowClient, "mock-mlflow-client", getEnvAsBool("MOCK_MLFLOW_CLIENT", false), "Use mock MLFlow client (localhost:5000)")
	...
	flag.StringVar(&cfg.MLFlowURL, "mlflow-url", getEnvAsString("MLFLOW_URL", "http://localhost:5000"), "MLFlow server URL")
